...
const registerSchema = z
  .object({
    ...
    gender: z.string().min(1, "Gender is required"),acceptPrivacy: z.boolean().refine((v) => v, { message: "You must accept the privacy policy" }),
  })
...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    setIsLoading(true);
    try {
      await authService.registerListener({
